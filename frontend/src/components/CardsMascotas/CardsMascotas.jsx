                ...
                <div className="row row-cols-1 row-cols-md-3 g-4">
                    <div className="col">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title text-center">Brenda</h5>
                    ...
                    <div className="col">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title text-center">Benja</h5>
                    ...
                    <div className="col">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title text-center">Oscar</h5>
                    ...
                    <div className="col">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title text-center">Leon</h5>
                    ...
                    <div className="col">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title text-center">Barto</h5>
                    ...
                    <div className="col">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title text-center">Peluza</h5>
